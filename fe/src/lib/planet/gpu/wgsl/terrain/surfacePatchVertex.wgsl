...
fn fs_main(in: VSOut) -> FSOut {
  ...
  // interpolated body dir (in.unit_dir), locked to the displaced geometry. (An earlier
  // ideal-sphere reconstruction for the fine texture noise drifted with view parallax.)
